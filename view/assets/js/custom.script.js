    ...
    $(document).ready(function() {
        ...
        if($('#lgx-typed-string').length){
            $('#lgx-typed-string').typed({
                strings: ["It's Our Festival 2020", "It's Our Festival 2020"],
                // typing speed
                typeSpeed: 10,
        ...
        if (typeof google != 'undefined') {
            ...
            if ($('.map-canvas-default').length) {
                $(".map-canvas-default").googleMap({
                    ...
                    coords: [-6.146210, 106.845822], // Map center (optional)
                ...
                $(".map-canvas-default").addMarker({
                    coords: [-6.146210, 106.845822], // GPS coords
                    title: 'Eventpoint',
                    text: 'JIExpo Kemayoran, Jakarta, Indonesia',
